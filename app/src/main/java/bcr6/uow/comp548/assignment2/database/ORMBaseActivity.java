 ...
 */
public abstract class ORMBaseActivity<H extends OrmLiteSqliteOpenHelper> extends AppCompatActivity {

    private volatile H helper;
    private volatile boolean created = false;
    private volatile boolean destroyed = false;
    private static final Logger logger = LoggerFactory.getLogger(ORMBaseActivity.class);
     ...
     * </p>
     */
    private H getHelperInternal(Context context) {
